...
class products(models.Model):
    ...
    image2 = models.ImageField(upload_to ='photo',default=0)
    image3 = models.ImageField(upload_to ='photo',default=0)
    image4 = models.ImageField(upload_to ='photo',default=0)
